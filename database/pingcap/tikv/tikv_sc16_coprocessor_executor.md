...
![图 1 DAG 样例](_v_images/20200913211215124_1415110843.png)
...
![图 2 DAG 执行流程样例](_v_images/20200913211214722_883549853.gif)
...
![图 3 向量化计算模型与标量计算模型对比](_v_images/20200913211214320_1838683344.png)
...
![图 4 向量化查询引擎benchmark](_v_images/20200913211213916_2049030494.png)
...
![图 5 行存转列存](_v_images/20200913211213613_1399875006.png)
...
![图 6 根据 a 列的值对行进行分组](_v_images/20200913211213210_1524844554.png)

然后，我们会遍历每个组，然后针对每个组求出每个聚合函数的值，在这里就是：

![图 7 遍历每个组求出聚合函数的值](_v_images/20200913211212907_1823159916.png)
...
![图 8 遍历所有聚合函数创建的状态](_v_images/20200913211212504_264953653.png)
